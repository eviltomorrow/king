...
func (c *storageClient) PushMetadata(ctx context.Context, opts ...grpc.CallOption) (Storage_PushMetadataClient, error) {
	...
	x := &storagePushMetadataClient{ClientStream: stream}
	return x, nil
}
...
func (c *storageClient) GetStockFull(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Storage_GetStockFullClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Storage_ServiceDesc.Streams[1], Storage_GetStockFull_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &storageGetStockFullClient{ClientStream: stream}
...
func _Storage_PushMetadata_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StorageServer).PushMetadata(&storagePushMetadataServer{ServerStream: stream})
}
...
func _Storage_GetStockFull_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StorageServer).GetStockFull(m, &storageGetStockFullServer{ServerStream: stream})
}
