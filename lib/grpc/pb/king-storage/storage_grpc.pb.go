...
type StorageClient interface {
	StoreMetadata(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[Metadata, StoreResponse], error)
...
func (c *storageClient) StoreMetadata(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[Metadata, StoreResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Storage_ServiceDesc.Streams[0], Storage_StoreMetadata_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Metadata, StoreResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Storage_StoreMetadataClient = grpc.ClientStreamingClient[Metadata, StoreResponse]
...
type StorageServer interface {
	StoreMetadata(grpc.ClientStreamingServer[Metadata, StoreResponse]) error
...
func (UnimplementedStorageServer) StoreMetadata(grpc.ClientStreamingServer[Metadata, StoreResponse]) error {
...
func _Storage_StoreMetadata_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StorageServer).StoreMetadata(&grpc.GenericServerStream[Metadata, StoreResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Storage_StoreMetadataServer = grpc.ClientStreamingServer[Metadata, StoreResponse]
