...
const (
	Email_RenderTemplate_FullMethodName = "/email.Email/RenderTemplate"
	Email_Send_FullMethodName           = "/email.Email/Send"
)
...
type EmailClient interface {
	RenderTemplate(ctx context.Context, in *TemplateData, opts ...grpc.CallOption) (*wrapperspb.StringValue, error)
...
func (c *emailClient) RenderTemplate(ctx context.Context, in *TemplateData, opts ...grpc.CallOption) (*wrapperspb.StringValue, error) {
	out := new(wrapperspb.StringValue)
	err := c.cc.Invoke(ctx, Email_RenderTemplate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmailServer interface {
	RenderTemplate(context.Context, *TemplateData) (*wrapperspb.StringValue, error)
...
func (UnimplementedEmailServer) RenderTemplate(context.Context, *TemplateData) (*wrapperspb.StringValue, error) {
...
func _Email_RenderTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TemplateData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmailServer).RenderTemplate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Email_RenderTemplate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServer).RenderTemplate(ctx, req.(*TemplateData))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Email_RenderTemplate_Handler,
		},
		{
			MethodName: "Send",
