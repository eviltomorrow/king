...
const (
	Repository_ArchiveMetadata_FullMethodName = "/repository.Repository/ArchiveMetadata"
	Repository_GetStockFull_FullMethodName    = "/repository.Repository/GetStockFull"
	Repository_GetQuoteLatest_FullMethodName  = "/repository.Repository/GetQuoteLatest"
)
...
func (c *repositoryClient) ArchiveMetadata(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*Counter, error) {
	out := new(Counter)
	err := c.cc.Invoke(ctx, Repository_ArchiveMetadata_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *repositoryClient) GetStockFull(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Repository_GetStockFullClient, error) {
	stream, err := c.cc.NewStream(ctx, &Repository_ServiceDesc.Streams[0], Repository_GetStockFull_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *repositoryClient) GetQuoteLatest(ctx context.Context, in *QuoteRequest, opts ...grpc.CallOption) (Repository_GetQuoteLatestClient, error) {
	stream, err := c.cc.NewStream(ctx, &Repository_ServiceDesc.Streams[1], Repository_GetQuoteLatest_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedRepositoryServer) ArchiveMetadata(context.Context, *wrapperspb.StringValue) (*Counter, error) {
...
func _Repository_ArchiveMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(wrapperspb.StringValue)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RepositoryServer).ArchiveMetadata(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Repository_ArchiveMetadata_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServer).ArchiveMetadata(ctx, req.(*wrapperspb.StringValue))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Repository_ArchiveMetadata_Handler,
		},
	},
