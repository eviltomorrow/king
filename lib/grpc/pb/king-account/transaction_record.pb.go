...
func file_transaction_record_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_transaction_record_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_transaction_record_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Record); i {
			case 0:
				return &v.state
			case 1:
		...
		file_transaction_record_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Fee); i {
			case 0:
				return &v.state
			case 1:
