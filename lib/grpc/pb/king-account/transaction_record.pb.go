...
const file_transaction_record_proto_rawDesc = "" +
	"\n" +
	"\x18transaction_record.proto\x12\aaccount\x1a\x1egoogle/protobuf/wrappers.proto\"X\n" +
	"\n" +
	"RecordResp\x12)\n" +
	"\arecords\x18\x01 \x03(\v2\x0f.account.RecordR\arecords\x12\x1f\n" +
	...
	"\x06action\x18\x04 \x01(\x0e2\x16.account.Record.ActionR\x06action\x12(\n" +
	"\x04type\x18\x05 \x01(\x0e2\x14.account.Record.TypeR\x04type\x12\x12\n" +
	"\x04code\x18\x06 \x01(\tR\x04code\x12\x12\n" +
	"\x04name\x18\a \x01(\tR\x04name\x12\x16\n" +
	"\x06volume\x18\b \x01(\x03R\x06volume\x12\x1f\n" +
	"\vclose_price\x18\t \x01(\x01R\n" +
	"closePrice\x12\x1e\n" +
	"\x03fee\x18\n" +
	" \x03(\v2\f.account.FeeR\x03fee\"\x1b\n" +
	"\x06Action\x12\a\n" +
	...
	"\x05money\x18\x04 \x01(\x01R\x05money2\x99\x01\n" +
	"\x11TransactionRecord\x12A\n" +
	"\fListByUserId\x12\x1c.google.protobuf.StringValue\x1a\x13.account.RecordResp\x12A\n" +
	"\fListByOpenID\x12\x1c.google.protobuf.StringValue\x1a\x13.account.RecordRespB\aZ\x05./;pbb\x06proto3"
